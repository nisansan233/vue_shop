  ...
  <div>
    ...
    <el-card>
      ...
      <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
        :current-page="this.$store.state.queryInfo.pagenum" :page-sizes="[1, 2, 5, 10]"
        :page-size="this.$store.state.queryInfo.pagesize" layout="total, sizes, prev, pager, next, jumper"
    ...
    <el-dialog title="修改用户" :visible.sync="editDialogVisable" width="50%">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="editDialogVisable = false">确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
